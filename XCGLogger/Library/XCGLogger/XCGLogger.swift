    ...
    private func openFile() {
        ...
        if let writeToFileURL = writeToFileURL,
          let path = writeToFileURL.path {
            ...
            let absoluteString = writeToFileURL.absoluteString ?? ""
            let logDetails = XCGLogDetails(logLevel: .Info, date: NSDate(), logMessage: "XCGLogger " + (fileExists && shouldAppend ? "appending" : "writing") + " log to: " + absoluteString, functionName: "", fileName: "", lineNumber: 0)
